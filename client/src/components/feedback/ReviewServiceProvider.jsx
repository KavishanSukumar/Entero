        ...
        <div className="m-2 grid col-span-2 lg:grid-cols-2  xl:grid-cols-4 ">
          ...
          <div className="p-6 bg-white rounded-lg border min-h-fit  border-gray-200 m-2 shadow-inner hover:scale-110 transition duration-300">
            ...
            <p className="mb-7 text-gray-700">
              Amazing service .Really appreciate how the crew worked so hard to
              make the event a reality.The food was really good and i would
              recommend this to anyone out there to make their events a dream
              come true...
              <b className="text-blue-400 cursor-pointer" onClick={handlePopup}>
                Read more
              </b>
            </p>
        ...
        <div className="bg-white fixed rounded-3xl shadow-2xl top-[20%] flex flex-col  w-[70%] mx-[15%] p-2">
          ...
          <div className="flex justify-around items-center p-1 w-full">
            <div className=" inline-flex justify-center items-center w-[70%] ">
              ...
              />
              <p className=" font-medium text-base">Shakir Saheel</p>
            </div>
          ...
          <div className="w-full p-2 shadow-xl mb-10 grid grid-cols-1">
            <div className=" bg-slate-100 p-2 text-center min-h-fit shadow-inner mx-2 rounded-xl mb-4">
              <p className="text-gray-700">
                <i>
                  Amazing service .Really appreciate how the crew worked so hard
                  to make the event a reality.The food was really good and i
                  would recommend this to anyone out there to make their events
                  a dream come true. You can find different packages according
                  to their needs.
                </i>
              </p>
            </div>
