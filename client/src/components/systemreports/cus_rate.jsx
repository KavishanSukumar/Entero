...
export default function cus_rate({visible,onClose}) {
    if (!visible) return null;

    return (
        <div className='flex  inset-0 bg-black bg-opacity-80 backdrop-blur-sm fixed'>
...
//         <div className='flex  flex-col bg-white-300 oder-1   flex-wrap gap-8 order-1 w-full  mt-20 ' >
//           <div className="flex  space-y-4 flex-row ml-5 text-2xl text-center  w-full">
...
//               </li>
//               <li class="nav-item" role="presentation">
//                 <a href="#tabs-profile" class="  nav-link  block  font-medium  text-xs  leading-tight  uppercase  border-x-0 border-t-0 border-b-2 border-transparent  px-6  py-3  my-2  hover:border-transparent hover:bg-gray-100  focus:border-transparent" id="tabs-profile-tab" data-bs-toggle="pill" data-bs-target="#tabs-profile" role="tab"
//                   aria-controls="tabs-profile" aria-selected="false">Events</a>
//               </li>
//               <li class="nav-item" role="presentation">
//                 <a href="#tabs-messages" class="  nav-link  block  font-medium  text-xs  leading-tight  uppercase  border-x-0 border-t-0 border-b-2 border-transparent  px-6  py-3  my-2  hover:border-transparent hover:bg-gray-100  focus:border-transparent" id="tabs-messages-tab" data-bs-toggle="pill" data-bs-target="#tabs-messages" role="tab"
...
//         <div className='flex flex-col tab-content order-2 mt-[-60px] ml-[-60px]' id="tabs-tabContent">
//  {/* 
// ========================================================================================================================================================================
//                                                                                       income
// ======================================================================================================================================================================== */}
