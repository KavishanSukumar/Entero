...
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsGem, BsShop, BsSunset } from 'react-icons/bs';
...
references to Entero Worldwide, LLC include www.topbrand.co, Entero S.A.S, Entero, Isla Avatara , Avatara Island, Entero, www.IslaAvatara.com and
www.AvataraIsland.com. The Entero website is a Information and registration site. By
using the Entero website, you consent to the data practices described in this
statement.</p><br />
<h4><b>Collection of your Personal Information</b></h4>
In order to better provide you with products and services offered, Entero may collect
personally identifiable information, such as your:<br />
{/* <ul>
  <li>1. First and Last Name</li>
  <li>2. Mailing Address</li>
  <li>3. E-mail Address</li>
  <li>4. Phone Number</li>
  <li>5. Job Title</li>
</ul> */}

&emsp;&emsp;&emsp;&emsp;1. First and Last Name<br />
&emsp;&emsp;&emsp;&emsp;2. Mailing Address<br />
&emsp;&emsp;&emsp;&emsp;3. E-mail Address<br />
&emsp;&emsp;&emsp;&emsp;4. Phone Number<br />
&emsp;&emsp;&emsp;&emsp;5. Job Title<br />
 
Entero may also collect anonymous demographic information, which is not unique to
you, such as your:<br />
&emsp;&emsp;&emsp;&emsp;1. Age<br />
&emsp;&emsp;&emsp;&emsp;2. Gender<br />
&emsp;&emsp;&emsp;&emsp;3. Household Income<br />
...
elect to use certain products or services. These may include: <br />
&emsp;&emsp;&emsp;&emsp;(a) registering for an account;<br />
&emsp;&emsp;&emsp;&emsp;(b) entering a sweepstakes or contest sponsored by us or one of our partners; <br />
&emsp;&emsp;&emsp;&emsp;(c) signing up for special offers from selected third parties; <br />
&emsp;&emsp;&emsp;&emsp;(d) sending us an email message; <br />
&emsp;&emsp;&emsp;&emsp;(e) submitting your credit card or other payment information when ordering and purchasing
products and services. <br />To wit, we will use your information for, but not limited to,
...
Entero collects and uses your personal information to operate and deliver the services
you have requested.<br />
<p>Entero may also use your personally identifiable information to inform you of other
products or services available from Entero and its affiliates.</p><br />
<h4><b>Sharing Information with Third Parties</b></h4>
Entero does not sell, rent or lease its customer lists to third parties.
<p>Entero may share data with trusted partners to help perform statistical analysis, send
...
services to Entero, and they are required to maintain the confidentiality of your
information.</p>
<p>Entero may disclose your personal information, without notice, if required to do so by
law or in the good faith belief that such action is necessary to: <br />
&emsp;&emsp;&emsp;&emsp;(a) conform to the edicts of the law or comply with legal process served on Entero or the site; <br />
&emsp;&emsp;&emsp;&emsp;(b) protect and defend the rights or property of Entero; and/or <br />
&emsp;&emsp;&emsp;&emsp;(c) act under exigent circumstances to protect the personal safety of users of Entero, or the public.</p><br />
...
by Entero. This information can include: your IP address, browser type, domain names,
...
use of the Entero website.</p><br />
<h4><b>Use of Cookies</b></h4>
<p>The Entero website may use "cookies" to help you personalize your online experience.
...
page. For example, if you personalize Entero pages, or register with Entero site or
services, a cookie helps Entero to recall your specific information on subsequent visits.
This simplifies the process of recording your personal information, such as billing
addresses, shipping addresses, and so on. When you return to the same Entero
website, the information you previously provided can be retrieved, so you can easily use
the Entero features that you customized.</p>
...
open an email from Entero or click on a link therein.</p>
<p>If you would like to stop receiving marketing or promotional communications via email
from Entero, you may opt out of such communications by Unsubcribe Link on Email or
...
<p>Entero reserves the right to change this Privacy Policy from time to time. We will notify
...
<p>Entero welcomes your questions or comments regarding this Statement of Privacy. If
you believe that Entero has not adhered to this Statement, please contact Entero
at:</p><br /> */}
<p className="content-center text-center">
Entero, LLC<br />
139 Fulton Street PH 1101<br />
Colombo, Sri Lanka 10038<br />
Email Address:<br />
entero@entero.com<br />
Telephone number:<br />
9175088953<br />
Effective as of August 20, </p>
              </p> </h3>
  </div>
);
